    ...
    return (
        <>
            ...
            className={`
                ...
                ${
                    isSelected
                        ? 'ring-2 sm:ring-3 md:ring-4 ring-blue-500 shadow-lg shadow-blue-500/50'
                        : 'hover:shadow-md hover:shadow-gray-600/50'
                }
            `}
        >
            <div className="relative w-full pb-[100%] sm:pb-[90%] md:pb-[80%] lg:pb-[72.22%]">
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-0.5 sm:p-1">
                    <p className="text-[10px] sm:text-xs font-bold text-white text-center leading-tight">{unit.name}</p>
                </div>
            </div>
            {isSelected && (
